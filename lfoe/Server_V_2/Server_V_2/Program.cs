...
namespace Server_V_2
{
    class Server : IDisposable
    {
        ...
        private void Client_Work(object obj_client)
        {
            ...
            using (TcpClient client = user.GetTcpClient())
            {
                using (Stream stream = client.GetStream())
                {
                    ...
                    while (true)
                    {
                        Console.WriteLine("Entr the command");
        ...
        ///////////////////////////////////////////main
        private void Client_telebot(object objclient)
        {
            using (TcpClient client = (TcpClient)objclient)
            {
                while (true)
                {
        ...
        connect:
            try
            {
                ...
                while (start)
                {
                    ...
                    Write(client.GetStream(), $"Hello user {username}");
